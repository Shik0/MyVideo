...
def video_download(vchannel, vdate, vstart_time, vend_time, vfull_playlist, vdownload_url):
    #get full playlist URL
    full_playlist_url = vfull_playlist.format(vchannel, vdate, vstart_time)
    ...
    for vURL in video_url_list[:url_index]:
        ...
        download_url = vdownload_url.format(vchannel,vURL)
